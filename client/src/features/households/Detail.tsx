  ...
  return (
    <div className="flex w-full items-center justify-start gap-8">
      ...
      <div className="grid gap-2">
        ...
        <HouseholdInfoItem label="Quan hệ với chủ hộ" value={resident?.quanHeVoiChuHo} />
      </div>
    </div>
  )
}
          ...
          <>
            ...
            <EachHouseholdInfoDiv label="Thành viên hộ khẩu">
              <div className="grid grid-cols-4 gap-6">
                {household.thanhVienHo
                  .filter(resident => resident._id !== household.chu_ho._id)
                  .map(resident => (
                    <HouseholdMember key={resident._id} resident={resident} />
                  ))}
              </div>
            </EachHouseholdInfoDiv>
          </>
