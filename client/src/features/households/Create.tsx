...
const Create = () => {
  ...
  const onFinish = async (values: any) => {
    ...
    try {
      ...
      setNewHousehold({ thanhVienHo: [] as IResident[] } as IHousehold)
          ...
          <div className="flex justify-between gap-4">
                  ...
                  <Select
                    ...
                    onSelect={value => {
                      setNewHousehold({
                        ...newHousehold,
                        idChuHo: value,
                        chu_ho: residents.find(resident => resident._id === value) as IResident
                      })
                    }}
                  />
                </Form.Item>
                  ...
                  onSelect={value => {
                    setNewHousehold({
                      ...
                      thanhVienHo: [
                        ...
                        residents.find(resident => resident._id === value) as IResident
                      ]
                    })
                  }}
                  onDeselect={value => {
                    setNewHousehold({
                      ...newHousehold,
                      thanhVienHo: newHousehold.thanhVienHo.filter(
            ...
            <EachHouseholdInfoDiv label="Chủ hộ" className="w-3/5">
              ...
              <div className={`mt-6 rounded-md`}>
                ...
                {newHousehold.thanhVienHo.length > 0 ? (
                  <div className="grid max-h-[500px] grid-cols-2 gap-y-2 overflow-y-scroll">
                    {newHousehold.thanhVienHo?.map(resident => (
                      <div
                        key={resident._id}
