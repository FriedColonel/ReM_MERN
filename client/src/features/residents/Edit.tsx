        ...
        {Object.keys(resident).length === 0 ? (
          ...
          <Form
            ...
            initialValues={{
              ...
              soCMT: resident.cmt?.soCMT,
              ngayCap: dayjs(resident.cmt?.ngayCap),
              noiCap: resident.cmt?.noiCap,
              quanHeVoiChuHo: resident?.quanHeVoiChuHo,
              idHoKhau: {
                value: resident.thanhVienHo?._id,
                label: `${resident.thanhVienHo?.chu_ho.hoTen} - ${resident.thanhVienHo?.maHoKhau}`
              }
            }}
            name="editResident"
            autoComplete="off"
          ...
          >
            ...
            >
              <Select
                showSearch
                disabled={Boolean(resident.duoc_khai_tu) || resident.quanHeVoiChuHo === 'Chủ hộ'}
